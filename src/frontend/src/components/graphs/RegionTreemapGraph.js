...
export default class RegionTreemapGraph extends Component {
  ...
  setSel(_kpi_sel, _year_sel, _region_sel) {
    ...
    console.log(_kpi_sel, _year_sel, data_kpi, all_years_filter)
  ...
  render() {
    const { load_state, graphData, all_years, kpi_head, all_kpi } = this.state
